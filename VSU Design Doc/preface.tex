...
Strike Universe (or VSU). In that it splits its time among sections
...
person. While those will likely be eliminated eventually, for the
moment, these can be assumed to be written by {\it JS} unless
