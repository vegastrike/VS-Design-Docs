...
canon. Chapter~\ref{chapt:uncategorized} contains a potpuorri of
...
happen correspond to any of the developers' ideas of what the future
...
comparable to the known scales of celestial objects. Complicating
things greatly was a desire for the game to be multiplayer, thus
ensuring that arbitrary time dilation would not be a viable gameplay
mechanic.

The VSU, therefore, has to provide an environment in which all of
these prerequisites can coexist. Some of the requisite features of
such an environment included

Contact with alien species implies FTL. For there to be something
recognizeable as an ``ongoing war'' on an interstellar scale, neither
the attacker (borders completely permeable to primary FTL mechanism)
nor the defender (fixed points of FTL transit) could be unduly
advantaged - hence two different mechanisms for FTL. Early attempts at
a unified FTL mechanism (point-point) that differed for in-system and
outsystem use only in terms of some sort of presumption of scalability
were eventually retconned due both to difficulties in reconciling the
ability to jump from one side of a system to another with the
necessary drawbacks for interstellar travel that this same system must
still possess. While the early point-point mechanism was widely
criticized for being too fast, its replacement (SPEC) was widely
criticized for being too slow, except by those who continued to argue
that hours, rather than minutes, should be the bare minimum for
...
reserved for libertarians. In the VSU, the statists will persist, and,
by the UtCS period, will have pulled much, though not nearly all, of
the frontier back under various degress of control.
...
% LocalWords:  Rimward Aera Andolians Deucalion TWHON Mechanists Klk'k
% LocalWords:  Andolian Purth LIHW Aerans Aeran Rlaan Shmrn Dgn Saahasayaay VSU
% LocalWords:  Alphans Betans UtCS RPG Replicants Battlestar Moby
