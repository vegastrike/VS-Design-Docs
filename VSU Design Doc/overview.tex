...
that dwarfs the experience of humanity by many orders of magnitude. Vega
Strike allows free form 'sandbox' style exploration even if deviations into a
story based campaign are also supported. Likewise it allows for players to
...
them achieve their goals. Multiplayer is a critical aspect to the universe as
...
allow for interesting conflicts and engagements.  Lastly,  Vega Strike must be
